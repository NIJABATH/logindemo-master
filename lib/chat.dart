...
class ChatScreeno extends StatefulWidget {
...
class _ChatScreenState extends State<ChatScreeno> {
...
class MessagesStream extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   //      // Create the list of message widgets.
   //
   //       final messages = snapshot.data != null?snapshot.data:"null";
   //
   // List<Widget> messageWidgets = messages!<Widget>((m) {
   //   final data = m.data as AnnouncementData;
   //   final messageText = data.message;
   //   final messageSender = data.name;
   //   final currentUser = data.name;
   //   // final timeStamp = data['timestamp'];
   //   return MessageBubble(
   //     sender: messageSender,
   //     text: messageText,
